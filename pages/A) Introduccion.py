...
st.subheader("•	Estratificado (brinda a todos los individuos de una población la misma probabilidad de ser seleccionados para ser encuestado.)")
st.subheader("•	Trietapico (muestreo en tres etapas para encuestas domiciliarias: sorteo de manzanas, sorteo de viviendas en las manzanas de acuerdo con un criterio sistemático y sorteo de personas en las viviendas de acuerdo con un criterio sistemático.)")
st.subheader("•	Por conglomerados (las personas de la población son seleccionadas al azar en forma natural, pero a partir de agrupaciones o clústeres o conglomerados previos.)")
