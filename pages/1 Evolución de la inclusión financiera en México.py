...
st.title("Evolución de la inclusión financiera en México")
 
st.subheader("")    
st.subheader("")    

image = Image.open('imagenes/1.jpg')

st.image(image, caption='Tabulados_ENIF_2021.xlsx. Pestaña: Evolucion')
