...
st.subheader("")    
st.subheader("¿Te informamos que… la razón principal por la cual población no realiza aportaciones voluntarias a su AFORE es: no le queda dinero para ahorrar? Aumentó 4 pp de 2018 a 2021")    
st.subheader("")
