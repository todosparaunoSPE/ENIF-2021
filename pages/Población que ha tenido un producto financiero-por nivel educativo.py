...
st.subheader("")    
st.markdown('<div style="text-align: justify;">¿Te informamos que…la población con estudios hasta el nivel medio superior aumento 4 pp en el año 2021 respecto del año 2018 en cuanto al tener un producto financiero?</div>', unsafe_allow_html=True) 
st.subheader("")  
st.markdown('<div style="text-align: justify;">B) Por nivel educativo</div>', unsafe_allow_html=True)     
