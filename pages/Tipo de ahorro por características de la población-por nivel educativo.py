...
st.subheader("")    
st.markdown('<div style="text-align: justify;">¿Sabías que… la población que más ahorra de manera formal y de manera informal tiene un nivel educativo de licenciatura y más?</div>', unsafe_allow_html=True) 
st.subheader("")
