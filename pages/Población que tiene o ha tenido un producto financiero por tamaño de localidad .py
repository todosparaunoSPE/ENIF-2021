...
st.subheader("")    
st.markdown('<div style="text-align: justify;">¿Sabías que…en el año 2021 la población de Rural se ha mantenido ligeramente constante en los años, 2015, 2018 y 2021 en cuanto a tener un producto financiero por tamaño de localidad? De igual forma sucede con la población urbana.</div>', unsafe_allow_html=True)
st.subheader("")
st.markdown('<div style="text-align: justify;">(porcentaje de la población adulta)</div>', unsafe_allow_html=True)
