...
st.subheader("")    
st.markdown('<div style="text-align: justify;">¿Sabías que… en el año 2021 disminuyó en 2 pp la población que no ha tenido ningún producto financiero?</div>', unsafe_allow_html=True)
st.subheader("") 
st.markdown('<div style="text-align: justify;">B) Población según los tipos de productos que ha tenido (2018-2021)</div>', unsafe_allow_html=True)
