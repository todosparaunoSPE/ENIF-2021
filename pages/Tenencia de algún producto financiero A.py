...
st.subheader("")    
st.markdown('<div style="text-align: justify;">¿Sabías que… el tener algún producto financiero se mantuvo constante en 2018 y 2021 en 68% de la población adulta encuestada? Y que en estos mismos años bajo 2 pp (puntos porcentuales) la población que tuvo algún producto financiero, respecto del año 2015.</div>', unsafe_allow_html=True)  
st.subheader("")
st.markdown('<div style="text-align: justify;">A) Población que tiene o ha tenido un producto financiero (2015-2021)</div>', unsafe_allow_html=True)  
