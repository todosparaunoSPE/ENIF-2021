...
st.subheader("")    
st.markdown('<div style="text-align: justify;">¿Para tú información… la población que más ahorra de manera informal lo hace guardando dinero en casa? Y disminuyó 5 pp en el año 2021 respecto del año 2018</div>', unsafe_allow_html=True)
st.subheader("")
st.markdown('<div style="text-align: justify;">B) Ahorro informal</div>', unsafe_allow_html=True)
